...
public class TestCase
{
    ...
    public static final int PRIORITY_MIN = rtandroid.Constants.THREAD_MIN_PRIORITY;
    public static final int PRIORITY_MAX = rtandroid.Constants.THREAD_MAX_PRIORITY;
